...
**Situation:** A critical production incident where MongoDB Ops Manger went down without impacting the database itself.
**Task:** I was responsible for diagnosing and resolving the issue quickly.
**Action:** I informed the stake-holders immediately, opened a Sev 1 support case with the vendor. While awaiting their response I performed basic troubleshooting and use Linux commands to analyze log files on the database nodes, coordinated with the infrastructure and the networking teams to understand if they were conducting any maintenance activities. I created a reference document for the vendor's support team within 30 minutes. I managed to find the root cause before connecting with support and took their help to expedite the implementation of a fix. After resolution, I documented the incident.
**Result:** The issue was resolved without downtime and the stake-holders were kept informed at each step.
**Learning:** Staying calm, methodical, and communicative is vital in high-pressure situations. Also, staying curios and making myself familiar with combing through log files without a UI is an essential skill.
