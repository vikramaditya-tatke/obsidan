...
5. Go to [[AWS IAM]] Identity Center
	1. Enable [[AWS IAM]] Identity Center in a region closet to you.
...
6. Now `Vikramaditya` should be provided the start_url obtained when the [[AWS IAM]] Identity Center instance was enabled in the region.
...
1. Sign in as root → [[AWS IAM]] → Create User
...
1. [[AWS IAM]] Identity Center → Enable
