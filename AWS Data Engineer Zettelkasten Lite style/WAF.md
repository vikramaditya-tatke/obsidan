...
Logs can be sent to [[CloudWatch and CloudTrail]], [[Kinesis#[[Kinesis Data Streams|Kinesis]] Data Firehose]], [[Amazon S3 Fundamentals|S3]]. These logs can be used in an event-driven architecture security response architecture to extract and identify intelligence to update the Web ACLs to enhance the security of the platform.

## WAF Rules and Rule Groups

- Rules require compute based on their complexity.
- Web ACLS [[EC2]] Units AKA (WCU) are an indication of the complexity of the rule and the maximum value is 1500.
