...
- **Identity Federation -** [[AWS IAM]] supports identity federation, which allows users with passwords elsewhere—like your corporate network or internet identity provider—to get temporary access to your AWS account.
- Free to Use
...
*Whenever an [[AWS IAM]] identity makes a request, AWS evaluates the policies associated with them*
...
An [[EC2|EC2]] instance transitions between different states from the moment you create it until its termination.
