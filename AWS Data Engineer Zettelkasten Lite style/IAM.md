...
> An IAM Principal can only access an [[S3 Fundamentals|S3]] object if the user IAM permissions allow it OR the resource policy allows it AND there's no explicit DENY.

## Resource Policies
- Attached to a resource (e.g., [[S3 Fundamentals|S3]] buckets, [[SQS]] queues, KMS keys, [[Lambda]] functions).
...
- *[[S3 Fundamentals|S3]] Bucket Policies*: Bucket-wide rules from the [[S3 Fundamentals|S3]] console - allows cross account
