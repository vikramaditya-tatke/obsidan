...
3. **Cross Join**: Returns all possible combination of rows from both the tables. It amps every row on the left table to every row on the right table resulting in a cartesian product.
